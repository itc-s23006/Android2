    ...
    Column(
        ...
        Row(horizontalArrangement = Arrangement.spacedBy(16.dp)) {
            Button(onClick = {
                ...
                Text(text = stringResource(R.string.gu))
            }
            Button(onClick = {
                myHand = 1
                comHand = (0..2).random()
                ...
                Text(text = stringResource(R.string.choki))
            }
            Button(onClick = {
                myHand = 2
                comHand = (0..2).random()
                ...
                Text(text = stringResource(R.string.pa))
            }
        }
...
fun ResultView(modifier: Modifier = Modifier, result: Int) {
    when (result) {
        ...
        1 -> Text(
            text = stringResource(R.string.player_win),
            fontSize = 32.sp,
