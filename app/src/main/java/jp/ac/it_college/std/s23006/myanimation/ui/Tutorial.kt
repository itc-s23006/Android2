package jp.ac.it_college.std.s23006.myanimation.ui
...
private fun TutorialPreview() {
    Tutorial(
        ...
        description = "consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labure et dolore manga aliqua",
        pageOffset = 0f
    )
}